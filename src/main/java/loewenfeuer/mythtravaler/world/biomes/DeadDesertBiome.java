...
public class DeadDesertBiome extends Biome
{

	public DeadDesertBiome()
	{
		super((new Biome.Builder())
				.surfaceBuilder(SurfaceBuilder.DEFAULT, MTDefaultSurfaceBuilder.DEAD_SAND_SAND_SAND_CONFIG)
